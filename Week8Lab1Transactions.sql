...
ALTER DATABASE jhonr1_TSQL2012 SET ALLOW_SNAPSHOT_ISOLATION ON;
...
-- 2-6a
-- Turn on READ_COMMITTED_SNAPSHOT in the jhonr1_TSQL2012 database: (in SQL Azure ON by default)
ALTER DATABASE jhonr1_TSQL2012 SET READ_COMMITTED_SNAPSHOT ON;
...
ALTER DATABASE jhonr1_TSQL2012 SET ALLOW_SNAPSHOT_ISOLATION OFF;
ALTER DATABASE jhonr1_TSQL2012 SET READ_COMMITTED_SNAPSHOT OFF;
