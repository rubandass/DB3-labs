...
Sales.Customer
	...
	*************************
	...
	SELECT TOP 3 * FROM AdventureWorks2016.Sales.Customer
	SELECT TOP 3 * FROM AdventureWorks2016.Production.Product
	SELECT TOP 3 * FROM AdventureWorks2016.Sales.SalesOrderDetail
	SELECT TOP 3 * FROM AdventureWorks2016.Sales.SalesOrderHeader
